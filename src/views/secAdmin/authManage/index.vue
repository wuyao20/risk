...
import { departmentList, secAdminGetUserAccess, getAllWorkCode, adminUpdateUserAccess, adminDeleteUserAccess } from '../../../api/admin'
...
export default {
  ...
  methods: {
    ...
    handleFilter() {
      ...
      secAdminGetUserAccess(this.listQuery).then(res => {
